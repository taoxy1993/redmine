class Timesheet
  ...
  # Gets all the time_entries for all the projects by department
  def fetch_time_entries_for_department
    self.time_entries = { }
    case self.sort
      when :project
        fetch_time_entries_for_department_by_project
      when :user
        fetch_time_entries_for_department_by_user
      when :issue
        fetch_time_entries_for_department_by_issue
      else
        fetch_time_entries_for_department_by_project
    end
  end
  ...
  def fetch_time_entries_for_department_by_project
    self.projects.each do |project|
      logs = []
      users = []
  ...
  def fetch_time_entries_for_department_by_user
    self.users.each do |user_id|
      logs = []
  ...
  #                    issue => {:logs => [time entries]}
  #
  def fetch_time_entries_for_department_by_issue
    self.projects.each do |project|
      logs = []
      users = []
      project.issues.each do |issue|
